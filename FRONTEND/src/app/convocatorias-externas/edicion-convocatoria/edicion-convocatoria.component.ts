...
@Component({
  selector: 'app-edicion-convocatoria',
  templateUrl: './edicion-convocatoria.component.html',
  styleUrls: ['./edicion-convocatoria.component.scss']
})
export class EdicionConvocatoriaComponent implements OnInit {
