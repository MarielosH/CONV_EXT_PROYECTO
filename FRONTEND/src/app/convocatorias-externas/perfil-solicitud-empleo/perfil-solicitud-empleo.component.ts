...
import { Departamentos } from 'app/models/departamentos';
...
@Component({
  selector: 'app-perfil-solicitud-empleo',
  templateUrl: './perfil-solicitud-empleo.component.html',
  styleUrls: ['./perfil-solicitud-empleo.component.scss']
})
export class PerfilSolicitudEmpleoComponent implements OnInit {
