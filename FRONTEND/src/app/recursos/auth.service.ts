...
export class AuthService {
  ...
  public setsession(value: any) {
    this.session = value;
    //Se guardan las constantes en  local Storage para posteriormente usarlas en CanActivate
    //y así validar en acceso a las paginas mediante el uso directo de la URL
    this.localStorageService.setItem("CONSTANTES",btoa(JSON.stringify(value.CONSTANTES)));
  }
