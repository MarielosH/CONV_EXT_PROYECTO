...
public class HabilidadHumanaManager {
	String SCHEMA = new Config().getDBSchema();
	
	public jsonResult inHabilidadHumana(HabilidadesHumanas habilidadHumana, Integer convocatoria) throws Exception{
	...
	public List<Map<String, Object>> getHabilidadHumana(Integer convocatoria) throws Exception {
	...
	public jsonResult modHabilidadHumana(HabilidadesHumanas habilidadHumana, Integer id) throws Exception {
		ConnectionsPool c = new ConnectionsPool();
		Connection conn = c.conectar();
		jsonResult salida = new jsonResult();
	...
	public jsonResult modVisibilidadHabilidadHumana(Integer id) throws Exception {
		ConnectionsPool c = new ConnectionsPool();
		Connection conn = c.conectar();
		jsonResult salida = new jsonResult();
